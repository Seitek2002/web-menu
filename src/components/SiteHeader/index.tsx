            ...
            <div className="container">
                <div className="siteHeader__content">
                    ...
                    <div className="siteHeader__block">
                        ...
                        <div className={isLanguageOpen ? "siteHeader__language active" : "siteHeader__language"}>
                            <div className={`siteHeader__language-selected ${ isLanguageOpen ? "active" : "" }`} onClick={toggleLanguageMenu} > {active} <img src={arrow} alt="arrow" /> </div>
                            <div className={`siteHeader__wrapper ${isLanguageOpen ? "active" : ""}`}>
                                {list.filter((item) => item != active).map((item) =>  (
                            <div className="siteHeader__item" onClick={() => selectLanguage(item)} key={item}>{item}</div>
                             ))}
                            </div>
                        </div>
                    </div>
