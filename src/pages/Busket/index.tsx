                    ...
                    <Modal title={title} onClose={() => setModal(false)}>
                        {title === "Очистить корзину?" ? (
                            <div className="busket-modal-btns">
                                <button onClick={() => setModal(false)} className="busket-modal-gray">
                                    Да
                                </button>
                                <button onClick={() => setModal(false)} className="busket-modal-purple">
                                    Отменить
                                </button>
                            </div>
                        ) : (
                            <>
                                <p className="busket-modal-text">Вы можете оформить заказ с собой</p>
                                <button onClick={() => setModal(false)} className="busket-modal-btn">
                                    Взять с собой
                                </button>
                            </>
                        )}
