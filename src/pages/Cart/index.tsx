...
const Cart: React.FC = () => {
  ...
  const isButtonDisabled = useMemo(() => {
    ...
    return phoneNumber.length >= 13 && address.trim().length > 3;
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    if (userData.type) {
      const idx = orderTypes.findIndex((item) => item.value === userData.type);
      if (idx !== -1) {
        setActiveIndex(idx);
      }
    }
                      ...
                      {activeIndex === index ? (
                        ...
                        >
                          <g clipPath='url(#clip0_248_22508)'>
                            <path
                              d='M10 1.875C8.39303 1.875 6.82214 2.35152 5.486 3.24431C4.14985 4.1371 3.10844 5.40605 2.49348 6.8907C1.87852 8.37535 1.71762 10.009 2.03112 11.5851C2.34463 13.1612 3.11846 14.6089 4.25476 15.7452C5.39106 16.8815 6.8388 17.6554 8.4149 17.9689C9.99099 18.2824 11.6247 18.1215 13.1093 17.5065C14.594 16.8916 15.8629 15.8502 16.7557 14.514C17.6485 13.1779 18.125 11.607 18.125 10C18.1227 7.84581 17.266 5.78051 15.7427 4.25727C14.2195 2.73403 12.1542 1.87727 10 1.875ZM13.5672 8.56719L9.19219 12.9422C9.13415 13.0003 9.06522 13.0464 8.98934 13.0779C8.91347 13.1093 8.83214 13.1255 8.75 13.1255C8.66787 13.1255 8.58654 13.1093 8.51067 13.0779C8.43415 13.0464 8.36542 13.0003 8.30757 12.9422L6.43257 11.0672C6.31552 10.9499 6.24983 10.7909 6.24983 10.625C6.24983 10.4591 6.31552 10.3002 6.43257 10.1828C6.54962 10.0653 6.70871 9.99963 6.87458 9.99963C7.04044 9.99963 7.19953 10.0653 7.31658 10.1828L8.75 11.6164L12.6828 7.68281C12.741 7.62474 12.8099 7.57868 12.8858 7.54725C12.9616 7.51583 13.043 7.49967 13.125 7.49967C13.207 7.49967 13.2884 7.51583 13.3642 7.54725C13.44 7.57868 13.5089 7.62474 13.5672 7.68281C13.6253 7.74088 13.6713 7.80982 13.7027 7.88569C13.7341 7.96157 13.7503 8.04292 13.7503 8.12499C13.7503 8.20706 13.7341 8.28841 13.7027 8.36428C13.6713 8.44016 13.6253 8.50909 13.5672 8.56719Z'
                              fill={colorTheme}
                            />
                          </g>
                          <defs>
