          ...
          {data?.status === 0 ? (
            <h2>
              <svg
                ...
                xmlns='http://www.w3.org/2000/svg'
              >
                <g clipPath='url(#clip0_248_25521)'>
                  <path
